...
const CustomVideo = (props) => {
    ...
    return (
        ...
        <video className={props.isPageChanging ? exitClass : initialClass} src={props.src} controls={true} autoPlay={false} playsInline={true} onLoad={handleImageLoad} onLoadedData={handleImageLoad}/>
        </>
    )
}
